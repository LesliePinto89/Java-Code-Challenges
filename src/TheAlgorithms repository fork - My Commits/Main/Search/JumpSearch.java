...
public class JumpSearch {
	 ...
	 * fixed blocks in a sorted array, and linear searches back on itself to
	 * find it.
	 * 
	...
	public <T extends Comparable<T>> int checkCondition(T arr[], T key, int arrLength) {
		...
		// Use ternary operator to find min value between step and array length
	...
	public <T extends Comparable<T>> int linearSearchBlock(T arr[], T key, int step, int previous, int keyValueInt,
		...
		// Linear search starting from previous block fowards.
