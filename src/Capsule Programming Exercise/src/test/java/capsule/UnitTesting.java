...
public class UnitTesting {
	...
	public void applicationTestCases() {
		...
		/* Test 2 - Ensure each one of a cell's adjacent neighbours
		 can be checked for live bacteria cells with mechanisms 
		...
		/* Test 4 - Check that the user can end the simulation after 
		   a new generation successfully passes*/
		assertEquals(true, startTest.nextIteration("N"));
		

		/* Test 5 - Check that a given dish/matrix is populated with 
		 *grid like empty cells to later be filled with pair values.
